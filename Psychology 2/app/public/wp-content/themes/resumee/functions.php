...
// Font size presets
function resumee_theme_setup_font_presets() {
	add_theme_support( 'editor-font-sizes', array(
    array(
        'name' => __( 'Small', 'resumee' ),
        'size' => 12,
        'slug' => 'small'
    ),
    array(
        'name' => __( 'Regular', 'resumee' ),
        'size' => 16,
        'slug' => 'regular'
    ),
    array(
        'name' => __( 'Large', 'resumee' ),
        'size' => 36,
        'slug' => 'large'
    ),
    array(
        'name' => __( 'Huge', 'resumee' ),
        'size' => 50,
        'slug' => 'huge'
	    )
	) );
...
add_action( 'after_setup_theme', 'resumee_theme_setup_font_presets' );


// add color palette support
function resumee_setup_theme_supported_color() {
    add_theme_support( 'editor-color-palette', array(
        array(
            'name' => __( 'Light Blue', 'resumee' ),
            'slug' => 'light-blue',
            'color' => '#d3e9f3',
        ),
        array(
            'name' => __( 'Material Green', 'resumee' ),
            'slug' => 'material-green',
            'color' => '#4CAF50',
        ),
        array(
            'name' => __( 'Light Gray', 'resumee' ),
            'slug' => 'light-gray',
            'color' => '#eee',
        ),
        array(
            'name' => __( 'Dark Gray', 'resumee' ),
            'slug' => 'dark-gray',
            'color' => '#111',
	        ),
	    ) );
...
add_action( 'after_setup_theme', 'resumee_setup_theme_supported_color' );
