...
?>
		...
		<div class="row">
			...
			<div class="row">
					...
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/trumbowyg.jpg'); ?>" alt="<?php esc_html_e( 'Why Upgrade To resumee Pro', 'resumee' ); ?>" />
					</div>
			...
			<div class="row">
					<div class="col-md-7 dashboard-upgrade-left">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/template.png'); ?>" alt="<?php esc_html_e( 'Lots of Templates', 'resumee' ); ?>">
					</div>
					<div class="col-md-5 dashboard-upgrade-right">
			...
			<div class="row">
					<div class="col-md-7 dashboard-upgrade-left">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/svg.jpg'); ?>" alt="<?php esc_html_e( 'SVG Generator', 'resumee' ); ?>">
					</div>
					<div class="col-md-5 dashboard-upgrade-right">
			...
			<div class="col-md-12 text-block no-bottom-margin">
				<div class="row">
					<div class="col-md-7 dashboard-upgrade-left">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/adv.jpg'); ?>" alt="<?php esc_html_e( 'Advance Widget Options', 'resumee' ); ?>">
					</div>
					<div class="col-md-5 dashboard-upgrade-right">
			...
			<div class="col-md-12 text-block no-bottom-margin">
				<div class="row">
					<div class="col-md-7 dashboard-upgrade-left">
					<img src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/editor.png'); ?>" alt="<?php esc_html_e( 'Trumbowyg Editor Options', 'resumee' ); ?>">
					</div>
					<div class="col-md-5 dashboard-upgrade-right">
			...
			<div class="col-md-12 text-block no-bottom-margin">
				<div class="row">
					...
					<img style="width: 100%;" src="<?php echo esc_url(get_template_directory_uri() . '/assets/image/resumee-theme-reviews.jpg'); ?>" alt="<?php esc_html_e( 'Trumbowyg Editor Options', 'resumee' ); ?>">
					</div>
